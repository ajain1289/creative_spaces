...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$180000$sXEvLJXp0hRs$4gz1S++8xaGRTVrGuJBU7TN+YbUjJ6d1nOu266Frb8I=','2020-04-25 07:58:10.159246',1,'creative_spaces','','','',1,1,'2020-04-25 07:56:20.386390');
...
INSERT INTO `backend_app_userrole` VALUES (1,'admin');
...
INSERT INTO `django_admin_log` VALUES (1,'2020-04-25 08:01:12.138219','1','UserRole object (1)',1,'[{\"added\": {}}]',7,1),(2,'2020-04-25 08:01:35.044014','1','UserRole object (1)',2,'[{\"changed\": {\"fields\": [\"Role name\"]}}]',7,1);
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(7,'backend_app','userrole'),(5,'contenttypes','contenttype'),(6,'sessions','session');
...
-- Dump completed on 2020-04-25 13:47:56
